...
import { ArrowLeft, Plus, Search, RefreshCw, AlertCircle, Building2, Users, UserCog, Trash2 } from 'lucide-react';
...
const Departments = () => {
  ...
  const handleDeleteDept = async (deptId, deptName) => {
    if (!window.confirm(`Delete "${deptName}"? This will remove all associated data.`)) return;
    
    try {
      await tenantApi.deleteDepartment(deptId);
      await fetchDepartments();
                ...
                <div key={dept.department_id} style={{
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
                    <button 
                      ...
                      onClick={() => handleDeleteDept(dept.department_id, dept.department_name)}
